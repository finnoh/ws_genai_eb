...
## {background-iframe="https://epoch.ai/frontiermath/open-problems/ramsey-hypergraphs" interactive=true}


## Course Structure {.smaller}

<!-- TODO: Update this -->
<!-- TODO: Update time schedule below -->
...
2. Data Collection
3. Literature Review
4. Data Analysis & Coding 1
5. Data Analysis & Coding 2
6. Writing & Valorization
...
```
You: I want to work on E3.

Jan: +------------------------------------------+
     | Exercise E3 - Prompt Engineering        |
     | Objective: Write an effective prompt    |
     | Deliverable: One prompt + output       |
     +------------------------------------------+
