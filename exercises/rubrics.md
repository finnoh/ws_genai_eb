...
Scale for all criteria: 0 (missing), 1 (weak), 2 (acceptable), 3 (strong).

## Canonical base rubric (use for every exercise)

- Usefulness: does the output help the stated task?
- Correctness: is it factually/procedurally sound?
