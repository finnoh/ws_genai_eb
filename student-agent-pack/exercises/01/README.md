# E01 Hello-World Scaffold

Use this folder for Exercise E01.
...
```bash
uv run python exercises/01/hello_world.py
```
...
```bash
uv run python tools/print_exercise_packet.py --exercise-id E01
```
